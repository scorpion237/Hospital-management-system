    ...
    <div class="flex items-center justify-center bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-60 border border-gray-200 ">
        <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2  bg-white p-4">
            <p class="text-xl pb-6 flex items-center">
                <i class="fas fa-user mr-3"></i> Nouvel Employer
            </p>
           <form method="POST" wire:submit.prevent='store'>
            <div class="leading-loose">
                ...
                <div class="mt-2">
                    ...
                    <select name="function_id" wire:model='function_id' class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="">
                        <option value=""></option>
                ...
                <div class="mt-6">
                    <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit">Enregistrer Employer</button>
                </div>
